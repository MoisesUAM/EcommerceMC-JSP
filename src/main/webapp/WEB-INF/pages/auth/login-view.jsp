<jsp:include page="/WEB-INF/templates/header.jsp">
    <jsp:param name="pageName" value="Login | StoreMC"/>
</jsp:include>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="card border border-2 border-warning" style="min-width: 90%;">
                            <div class="card-header bg-dark "><h4 class="text-center text-white fw-bolder"> Iniciar
                                Sesión </h4></div>
                            <div class="card-body">
                                <form action="login" class="needs-validation" method="post" novalidate>
                                    ...
                                    <div class="mb-3">
                                        <button type="submit" class="btn btn-outline-dark"><i
                                                class="bi bi-arrow-right"></i>&nbsp; Iniciar Sesión
                                        </button>
                                    </div>
                                </form>
                            </div>
