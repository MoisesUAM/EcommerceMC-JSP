...
<div class="d-flex justify-content-center">
	<div class="container-sm">
		<div class="row-cols-6 mb-3">
			<button type="button" class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#roleAddModal">
				<i class="bi bi-person-add"></i>&nbsp;Agregar Role
			</button>
		</div>
		<hr class="text-danger">
		<div class="row">
			...
			<div class="modal-body">
				<div class="row">
					<form action="role" method="post" class="needs-validation" novalidate>
						...
						<div class="col-12">
							<div class="mb-3">
								<label for="roleName" class="form-label">Nombre de Rol</label> <input type="text" class="form-control" id="roleName" name="roleName" required />
								<div class="invalid-feedback">El campo nombre de rol es obligatorio</div>
							</div>
							<div class="mb-3">
								<label for="roleDescription" class="form-label">Descripcion del Rol</label> <input type="text" class="form-control" id="roleDescription" name="roleDescription"
									required />
								<div class="invalid-feedback">El campo nombre de rol es obligatorio</div>
							</div>
							<div class="mb-3 form-check form-switch">
								<input type="checkbox" class="form-check-input" id="roleActive" name="roleActive" role="checkbox" /> <label class="form-check-label" for="isActive">Estado
									= <span id="roleActiveSpan" class="text-success fw-bolder">Activo</span>
								</label>
...
<jsp:include page="/WEB-INF/templates/footer.jsp">
	<jsp:param name="lessonName" value="Proyecto Ecommerce con Jakarta EE 10" />
</jsp:include>