...
<c:if test="${person.id == null || person == null}">
                           <div class="card-header">Agregar nuevo Registro o Persona</div>
</c:if>
                       ...
                       <div class="card-body">
                           <form class="needs-validation" action="persons-upsert" method="post" novalidate>
                               ...
                               <div class="mb-3">
                                   ...
                                   <input type="text" class="form-control" id="dniPerson" name="dniPerson" required="true" value="${person.dni}"/>
                                   <div class="invalid-feedback">El campo DNI es obligatorio</div>
                               </div>
                               <div class="mb-3">
                                   <label for="namePerson" class="form-label">Nombre</label>
                                   <input type="text" class="form-control" id="namePerson" name="namePerson" required="true" value="${person.name}"/>
                                   <div class="invalid-feedback">El campo nombre es obligatorio</div>
                               </div>
                               <div class="mb-3">
                                   <label for="lastNamePerson" class="form-label">Apellidos</label>
                                   <input type="text" class="form-control" id="lastNamePerson" name="lastNamePerson" required="true" value="${person.lastName}"/>
                                   <div class="invalid-feedback">El campo apellidos es obligatorio</div>
                               </div>
                                <div class="mb-3">
                                       <label for="birthDatePerson" class="form-label" id="birthDatePerson">Fecha Nacimiento</label>
                                       <input type="date" name="birthDatePerson" id="birthDatePerson" class="form-control" value="${person.birthDate}" required>
                                       <div class="invalid-feedback">La fecha es un campo obligatorio</div>
                                </div>
                                <div class="mb-3">
                                       <label for="citizenshipPerson" class="form-label" id="citizenshipPerson">Nacionalidad</label>
                                       <input type="text" name="citizenshipPerson" id="citizenshipPerson" class="form-control" value="${person.citizenship}" required>
                                       <div class="invalid-feedback">El campo nacionalidad es obligatorio es un campo obligatorio</div>
                                 </div>
                               <hr class="text-danger">
                               <div class="d-flex justify-content-around gap-2">
                                   <button type="submit" class="btn btn-outline-primary"><i class="bi bi-floppy2-fill"></i>&nbsp;Agregar</button>
                                   <a href="persons" role="button" class="btn btn-outline-warning"><i class="bi bi-arrow-return-left"></i>&nbsp;Regresar</a>
                               </div>
                           </form>
                       </div>
                   </div>
